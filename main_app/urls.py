...
urlpatterns = [
    ...
    path('guilds/<uuid:pk>/events/update/', views.EventUpdate.as_view(), name='event-update'),
    path('guilds/<uuid:pk>/events/delete/', views.EventDelete.as_view(), name='event-delete'),
